...
// const makeGallerySlideMarkup = ({ url, alt }) => {
//     return `<li class='galleryItem'>
//                 <img class='gallery-image' src='${url}' alt='${alt}'>
//             </li>`;
// };

// const makeGalleryMarkup = images.map(makeGallerySlideMarkup).join('');
...
// const galleryEl = document.querySelector('.gallery');
// const makeServersElement = products => {
//     const { name, description, price, available, onSale } = products;
//     return `<li>
//                 <h2 class='product__name'>${name}</h2>
//                 <p class='product__descr'>${description}</p>
//                 <p class='product__price'>Цена: ${price}</p>
//             </li>`;
// };
// const makeServersList = products.map(makeServersElement);
// console.log(makeServersList);
// galleryEl.insertAdjacentHTML('beforeend', makeServersList);
